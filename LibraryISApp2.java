...
//        } while(ch == true);
      ...
      // user will log out
       System.out.println("Retun to the menu or log out from system or Print the transction report: \n"
               + "L - log out\n"
               + "R - return to the menu\n"
               + "P - print the transction report");
         ...
         switch (codeCh) {
             ...
             case 'R':
                  ...
                  break;
             case 'P':
                  System.out.print("Print the report");
